...
alias gbd='git branch | fzf | cut -d "/" -f 3 | xargs git branch --delete'
alias gbd!='git branch | fzf | cut -d "/" -f 3 | xargs git branch --delete --force'
alias gc='git commit -v'
alias gc!='git commit -v --amend'
alias gcn!='git commit -v --no-edit --amend'
alias gcb='git checkout -b'
alias gco='gb --all | fzf | cut -d "/" -f 3 | xargs git checkout'
