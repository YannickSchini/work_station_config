...
alias gcom='git checkout $(git rev-parse --abbrev-ref origin/HEAD | cut -d "/" -f 2)'
...
alias grbm='git rebase $(git rev-parse --abbrev-ref origin/HEAD | cut -d "/" -f 2)'
alias grba='git rebase --abort'
alias grbc='git rebase --continue'
alias grbi='git rebase -i'
alias grbim='git rebase -i $(git rev-parse --abbrev-ref origin/HEAD | cut -d "/" -f 2)'
